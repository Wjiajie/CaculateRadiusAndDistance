...
int main(void)
{   
    Config cfg(visualization, caculate_distance, fit_cylinder_radius, cluster_threshold, temp_width_pixel, temp_height_pixel, template_width_mm, template_height_mm);
    const string intput_image_l = path + "/snap_venc2_6.jpg";
    const string intput_image_r = path + "/snap_venc3_6.jpg";
